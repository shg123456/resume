...
%---------------------------------------------------------
  \cventry
    {Ph.D. in Electrical and Computer Engineering | Research Assistant | Advisor: \href{https://pitt-photonics.github.io/}{Nathan Youngblood}}
    {University of Pittsburgh}
    {Pittsburgh, PA}
    {Spring 2020 - Dec. 2026 expected}
    {
      \begin{cvitems}
...
%---------------------------------------------------------
  \cventry
    ...
    {Atlanta, GA}
    {Spring 2024 - May 2027 expected}
    {
      \begin{cvitems}
        \item {Coursework: Machine Learning, Deep Learning, Computer Vision, Machine Learning for Trading, Game AI, AI Ethics and Society, and Introduction to Cognitive Science.}
        \item {Completed machine-learning projects covering supervised learning, unsupervised learning, reinforcement learning, randomized optimization, model selection, cross-validation, and error analysis; project datasets and metrics to be specified [details TBD].}
        \item {Developed deep-learning and computer-vision project experience in neural-network training, backpropagation, gradient-based optimization, CNN/RNN architectures, feature extraction, image geometry, and model evaluation for perception-oriented tasks [details TBD].}
        \item {Applied Python-based ML workflows in trading and decision-making projects, including regression, KNN/regression-tree learners, Q-learning, data preprocessing, parameter sweeps, and performance visualization.}
      \end{cvitems}
    }

%---------------------------------------------------------
  \cventry
    {M.S. in Optics | Research Assistant | Advisor: \href{https://labsites.rochester.edu/zhang/}{Xi-Cheng Zhang}}
    {University of Rochester}
    {Rochester, NY}
    {Sep 2017 - Aug 2019}
    {
      \begin{cvitems}
        \item {Conducted THz photonics research; generated THz signals from liquid plasmas and quantified how temperature, polarity, and viscosity affected emission strength, bandwidth, repeatability, and spectral content.}
...
%---------------------------------------------------------
  \cventry
    {B.S. in Optical Engineering | B.S. in Applied Mathematics}
    {University of Rochester}
    {Rochester, NY}
    {Sep 2013 - Aug 2017}
    {}
